...
@Component({
  ...
  templateUrl: './loai-ca-create.component.html',
  styleUrls: ['./loai-ca-create.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class LoaiCaCreateComponent implements OnInit {

  constructor(
    private activeModal: NgbActiveModal,
    private messageService: MessageService,
    private service: LoaiCaService,
  ...
  getLoaiCaInfo() {
    this.service.getLoaiCaInfo(this.id).subscribe(result => {
      if (result.isStatus) {
        setTimeout(() => {
  ...
  create(isContinue: any) {
    this.service.createLoaiCa(this.model).subscribe(
      result => {
        if (result.isStatus) {
  ...
  update() {
    this.service.updateLoaiCa(this.id, this.model).subscribe(
      result => {
        if (result.isStatus) {
